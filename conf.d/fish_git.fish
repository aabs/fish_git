...
fd2_define_command fdg "fishdots plugin for doing useful things with git"
fd2_define_subcommand fdg save __fd2_fdg_save "save all edits"
fd2_define_subcommand fdg sync __fd2_fdg_sync "save all edits then push to origin"
fd2_define_subcommand fdg release __fd2_fdg_release "(<ver> <msg>) Update release version, tag and push"
fd2_define_subcommand fdg tag __fd2_fdg_tag "(<ver> <msg>) release, without use of latest-release.txt file"
fd2_define_subcommand fdg ed __fd2_fdg_ed "find a file in the current repo and edit"
